...
In the next step, the resolved logical plan is passed through a *Catalyst optimizer*, a collection of rules that attempt to generate an *optimized logical plan* by pushing down predicates or selections.  
### Physical Plan  
